...
<html lang="en">
  <head>
    ...
    <title>LIGHT THE CLASSROOM|||Between Dates Reports</title>
    <!-- plugins:css -->
...
<h5 align="center" style="color:blue">Report from <?php echo $fdate?> to <?php echo $tdate?></h5>
                    ...
                    <div class="table-responsive border rounded p-1">
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            <th class="font-weight-bold">Admission Number</th>
                            <th class="font-weight-bold">First Name</th>
                            <th class="font-weight-bold">Last Name</th>
                            <th class="font-weight-bold">Age</th>
                            <th class="font-weight-bold">DOB</th>
                            <th class="font-weight-bold">Mother Tongue</th>
                            <th class="font-weight-bold">Religion</th>
                            <th class="font-weight-bold">Caste</th>
                            <th class="font-weight-bold">Sub Caste</th>
                            <th class="font-weight-bold">Blood Group</th>
                            <th class="font-weight-bold">Identification Marks(Scar)</th>
                            <th class="font-weight-bold">Identification Marks(Mole)</th>
                            <th class="font-weight-bold">Image</th>
                            <th class="font-weight-bold">Gender</th>
                            <th class="font-weight-bold">Disability</th>
                            <th class="font-weight-bold">Date of Join</th>
                            <th class="font-weight-bold">TC Number</th>
                            <th class="font-weight-bold">EMIS ID</th>
                            <th class="font-weight-bold">Aadhar Number</th>
                            <th class="font-weight-bold">Previous School With Address</th>
                            <th class="font-weight-bold">Study Medium</th>
