 <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex align-items-center"style="background-color:white">
          ...
          <a class="navbar-brand brand-logo-mini" href="dashboard.php"><img src="glow.png" alt="logo" /></a>
        </div><?php
...
{               ?>
        <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
          <h5 class="mb-0 font-weight-medium d-none d-lg-flex"tit>Welcome Admin</h5>
